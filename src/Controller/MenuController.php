...
class MenuController extends AbstractController
{
    ...
    #[Route('/new', name: 'app_menu_new', methods: ['GET', 'POST']), IsGranted('ROLE_ADMIN')]
    ...
    #[Route('/{id}/edit', name: 'app_menu_edit', methods: ['GET', 'POST']), IsGranted('ROLE_ADMIN')]
    ...
    #[Route('/{id}', name: 'app_menu_delete', methods: ['POST']), IsGranted('ROLE_ADMIN')]
