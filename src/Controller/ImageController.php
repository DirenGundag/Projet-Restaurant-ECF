...
{
    #[Route('/', name: 'app_image_index', methods: ['GET']), IsGranted('ROLE_ADMIN')]
    ...
    #[Route('/new', name: 'app_image_new', methods: ['GET', 'POST']), IsGranted('ROLE_ADMIN')]
    ...
    #[Route('/{id}', name: 'app_image_show', methods: ['GET']), IsGranted('ROLE_ADMIN')]
    ...
    #[Route('/{id}/edit', name: 'app_image_edit', methods: ['GET', 'POST']), IsGranted('ROLE_ADMIN')]
    ...
    #[Route('/{id}', name: 'app_image_delete', methods: ['POST']), IsGranted('ROLE_ADMIN')]
